...
class AddSpecificProblem extends Component {
    ...
    render () {
        const title="zackle Add Specific | Practice Coding OJ";
                            ...
                            <div className="offset-md-3 col-md-7 offset-2">
                                <form>
                                    <div className="row form-group">
                                        <label htmlFor="team" className="col-3 col-form-label col-form-label-sm">Problem Name</label>
                                        <div className="col-8 col-md-4">
                                            <input type="text" className="form-control form-control-sm" name="name" id="team" placeholder="Problem Name" />
                                        </div>
                                    </div>
...
export default withRouter(AddSpecificProblem);