...
import {fetchUSerComingContests, fetchUSerRunningContests, fetchUSerPastContests} from '../../../redux/actions/contestActions';
...
class UserContests extends Component {
    ...
    render() {
        if (this.props.contests.userContestsError) {
            ...
            const _coming = this.props.contests.userComingContests.length > 0;
            const _running = this.props.contests.userRunningContests.length > 0;
            const _past = this.props.contests.userPastContests.length > 0;
...
export default withRouter(connect(
    mapStateToProps,
    {deauthenticate, fetchUSerComingContests, fetchUSerRunningContests, fetchUSerPastContests}
)(UserContests));